...
const Foo = () => {
    ...
    <div className='grid grid-cols-4 place-items-center  justify-center items-center  mt-10 ml-10 mr-10  xs:grid-cols-1 xs:place-items-center  ' id='rowf1'>
       <div className='mt-10 mb-10 xs:ml-4'>
